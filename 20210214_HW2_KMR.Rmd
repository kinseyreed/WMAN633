...
#now plot histogram
hist(residuals1)
#Seems pretty lopsided to me. I suppose it could be considered "reasonably Gaussian" though.
...
#df = 62 - 6, = 56
pt(test_statA, df = 56) + (1 - pt(abs(test_statA), df = 56)) #7.79e-21
pt(-test_statB, df = 56) + (1 - pt(test_statB, df = 56)) #3.07e-13
pt(-test_statC, df = 56) + (1 - pt(test_statC, df = 56)) #7.96e-11
...
# BeachB p = 3.07e-13
# BeachC p = 7.96e-11
#B and C are the same, A is different but still very tiny. Not sure why or if it matters since still super small.
...
#rate of change (slope) is equal to :
betas[4] + betas[6]
#=-3.99 meaing that Beach C looses approximately 3.99 ha of open beach each year.    
